    ...
    <>
      ...
      >
        ...
        <div className="flex min-w-0 items-center justify-end gap-2 md:gap-4 2xl:gap-6 z-50">
          {/* Desktop Links */}
          <div className="hidden min-[1270px]:flex items-center justify-end whitespace-nowrap gap-3 min-[1600px]:gap-5">
            ...
            {isLoggedIn ? (
              <div className="relative">
                ...
                >
                  ...
                  <span className="max-w-[90px] min-[1350px]:max-w-[120px] truncate text-[10px] font-bold uppercase tracking-wider">
                    {user?.name || "Account"}
                  </span>
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed inset-0 bg-[#002155] z-40 min-[1240px]:hidden flex flex-col pt-24 px-6 transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
