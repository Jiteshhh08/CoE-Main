...
export const HUB_SOURCE_SEEDS: HubSourceSeed[] = [
  ...
  { key: 'devfolio', label: 'Devfolio', method: 'PAGE', frequency: 'DAILY', priority: 70, seedUrl: 'https://devfolio.co/hackathons' },
  { key: 'unstop', label: 'Unstop', method: 'PAGE', frequency: 'DAILY', priority: 70, seedUrl: 'https://unstop.com/hackathons' },
  { key: 'hackerearth', label: 'HackerEarth', method: 'PAGE', frequency: 'DAILY', priority: 70, seedUrl: 'https://www.hackerearth.com/challenges/hackathon/' },
  { key: 'hack2skill', label: 'Hack2Skill', method: 'PAGE', frequency: 'DAILY', priority: 70, seedUrl: 'https://hack2skill.com/hackathons' },
